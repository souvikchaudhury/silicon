...
function uploadSuccess(file, serverData) {
	try {
		...
		if (serverData.substring(0, 7) === "FILEID:") {
			...
			jQuery("#thumbnails").append('<span class="artWorkTitle">'+file.name+'</span> | <a href="javascript:void(0)" class="thumbdel" data-name="'+file.name+'">Delete</a>');
			upldimagesval = jQuery("#upldimages").val();
			upldimagesval = upldimagesval+','+file.name;
			jQuery("#upldimages").val(upldimagesval);
